...
typedef struct danos_backend_ops {
     ...
     * carries no usable path yet — backends may reject. */
    danos_status_t (*route_add)(const danos_route_t *route, void *user);
    danos_status_t (*route_del)(const danos_route_t *route, void *user);
