...
#define ZEBRA_FRR_ROUTE_ADD 8
#define ZEBRA_FRR_ROUTE_DELETE 9
#define ZEBRA_FRR_REDISTRIBUTE_ROUTE_ADD 30
#define ZEBRA_FRR_REDISTRIBUTE_ROUTE_DELETE 31
#define ZEBRA_FRR_HELLO 18
#define ZEBRA_FRR_ROUTER_ID_ADD 15
#define ZEBRA_FRR_ROUTER_ID_UPDATE 17
