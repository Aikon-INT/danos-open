...
require 'frr route event type=9 add=1' "$DANOS_LOG" 'BGP route add into DANOS'
require 'frr route event type=9 add=0' "$DANOS_LOG" 'BGP route withdraw from DANOS'
require 'End-of-RIB.*172\.31\.0\.3|172\.31\.0\.3.*End-of-RIB' "$FRR_LOG" 'FRR BGP route exchange'
